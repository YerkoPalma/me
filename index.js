...
router.addRoute('/projects', require('./views/projects'))
router.addRoute('/projects/:project', require('./views/project'), function (params) {
  var currentProject = state.projects[params.project]
